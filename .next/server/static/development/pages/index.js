...
/* harmony import */ var _single_item_carbon_metrics__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./single-item-carbon-metrics */ "./componenets/single-item-carbon-metrics.js");
...
function ResourceListWithProducts(props) {
  ...
  return __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_1__["Card"], {
    ...
    renderItem: item => {
      ...
      return __jsx("div", null, __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_1__["ResourceList"].Item, {
        id: item.id,
        media: media,
        accessibilityLabel: `View details for ${item.title}`
      }, __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_1__["Stack"], {
        onClick: store_js__WEBPACK_IMPORTED_MODULE_2___default.a.set('item', item)
      }, __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_1__["Stack"].Item, {
        fill: true
      }, __jsx("h3", null, __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_1__["TextStyle"], {
        variation: "strong"
      }))), __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_1__["Stack"].Item, null, __jsx(_single_item_carbon_metrics__WEBPACK_IMPORTED_MODULE_3__["default"], {
        item: item
      })))));
    }
  }));
...
class CarbonMetrics extends react__WEBPACK_IMPORTED_MODULE_9___default.a.Component {
  constructor(props) {
    super(props);
    this.state = {
      items: []
  ...
  async componentDidMount() {
    ...
    const promises = items.map(async item => {
      ...
      return await Axios__WEBPACK_IMPORTED_MODULE_10___default.a.get(`https://carbon-calculator-shopify.herokuapp.com/api/products/${name}/nutrition`);
    });

    _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_7___default.a.all(promises).then(result => {
  ...
  render() {
    ...
    }, __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_8__["Card"], null, __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_8__["DataTable"], {
...
/* harmony default export */ __webpack_exports__["default"] = (CarbonMetrics);

/***/ }),

/***/ "./componenets/single-item-carbon-metrics.js":
/*!***************************************************!*\
  !*** ./componenets/single-item-carbon-metrics.js ***!
  \***************************************************/
/*! exports provided: default */
...
function SingleItemCarbonMetrics(props) {
  ...
  const handleToggle = Object(react__WEBPACK_IMPORTED_MODULE_7__["useCallback"])(() => setActive(active => !active), []);
  Object(react__WEBPACK_IMPORTED_MODULE_7__["useEffect"])(() => {
    const fetchData = async () => {
      const name = props.item.title;
      const result = await Axios__WEBPACK_IMPORTED_MODULE_9___default.a.get(`https://carbon-calculator-shopify.herokuapp.com/api/products/${name}/nutrition`);
      setItem(_objectSpread({}, props.item, {}, result.data));
    };

    fetchData();
  }, []);
  return __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_8__["Page"], null, __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_8__["Card"], null, __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_8__["Button"], {
    onClick: handleToggle,
    ariaExpanded: active,
    ariaControls: "basic-collapsible"
  }, !active ? 'See Metrics' : 'Close'), __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_8__["Collapsible"], {
    open: active,
    id: "basic-collapsible"
  }, __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_8__["DataTable"], {
    columnContentTypes: ['text', 'numeric', 'numeric', 'numeric', 'numeric', 'numeric'],
    headings: ['Product', 'Calories', 'Iron content (g)', 'Calcium (g)', 'Vitimin A (g)', 'Serving Size (Cups)'],
...
/* harmony default export */ __webpack_exports__["default"] = (SingleItemCarbonMetrics);
...
/* harmony import */ var _componenets_ResourceList__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../componenets/ResourceList */ "./componenets/ResourceList.js");
/* harmony import */ var _componenets_carbon_metrics__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../componenets/carbon-metrics */ "./componenets/carbon-metrics.js");
...
class Index extends react__WEBPACK_IMPORTED_MODULE_1___default.a.Component {
  ...
  render() {
    ...
    return __jsx(react_apollo__WEBPACK_IMPORTED_MODULE_3__["Query"], {
      ...
      return __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_4__["Page"], null, __jsx(_shopify_app_bridge_react__WEBPACK_IMPORTED_MODULE_5__["TitleBar"], {
      ...
      }), __jsx(_shopify_app_bridge_react__WEBPACK_IMPORTED_MODULE_5__["ResourcePicker"], {
      ...
      }), emptyState ? __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_4__["Layout"], null, __jsx(_shopify_polaris__WEBPACK_IMPORTED_MODULE_4__["EmptyState"], {
        ...
        image: img
      }, __jsx("p", null, "Select products to change their price temporarily."))) : __jsx(_componenets_ResourceList__WEBPACK_IMPORTED_MODULE_7__["default"], {
        items: data.nodes
      }), __jsx(_componenets_carbon_metrics__WEBPACK_IMPORTED_MODULE_8__["default"], {
        items: data.nodes
      }));
    });
  }
